...
def merge_translated_datasets():
    ...
    reddit_df = pd.read_csv("data/suicidal_ideation_reddit_pt.csv")
    twitter_df = pd.read_csv("data/suicidal_ideation_twitter_pt.csv")
    ...
    output_path = "data/merged_dataset_pt.csv"
